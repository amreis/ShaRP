...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="experiment_5")
    parser.add_argument("--output-dir", type=str, default="results_bubblyness")
    ...
    data_dir = "../data"
    data_dirs = ["mnist", "fashionmnist", "har", "reuters", "usps"]
    ...
    for d in data_dirs:
        ...
        for model_config in (
            ...
            results.append(
                (
                    dataset_name,
                    f'{model_config["kl_weight"]:.3g}',
                    f'{model_config["kl_mu_weight"]:.3g}',
                )
            ...
            fname = os.path.join(
                ...
                (
                    f"{dataset_name}"
                    f"_klw={model_config['kl_weight']:.3g}"
                    f"_klmw={model_config['kl_mu_weight']:.3g}.png"
                ),
            )
            print(fname)
