...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="results_kl_mu_weight")
    parser.add_argument(
    ...
    experiment_configs = [
        ExperimentConfig("diagonal_normal", kl_weight=0.01, kl_mu_weight=1.0),
        ExperimentConfig("diagonal_normal", kl_weight=0.01, kl_mu_weight=0.5),
        ExperimentConfig("diagonal_normal", kl_weight=0.01, kl_mu_weight=0.1),
        ExperimentConfig("diagonal_normal", kl_weight=0.01, kl_mu_weight=0.0),
        ExperimentConfig("diagonal_normal", kl_weight=0.1, kl_mu_weight=1.0),
        ExperimentConfig("diagonal_normal", kl_weight=0.1, kl_mu_weight=0.5),
        ExperimentConfig("diagonal_normal", kl_weight=0.1, kl_mu_weight=0.1),
        ExperimentConfig("diagonal_normal", kl_weight=0.1, kl_mu_weight=0.0),
        ExperimentConfig("diagonal_normal", kl_weight=0.5, kl_mu_weight=1.0),
        ExperimentConfig("diagonal_normal", kl_weight=0.5, kl_mu_weight=0.5),
        ExperimentConfig("diagonal_normal", kl_weight=0.5, kl_mu_weight=0.1),
        ExperimentConfig("diagonal_normal", kl_weight=0.5, kl_mu_weight=0.0),
    ]
